...
* Tue Dec 14 2021 03:55:03 GMT-0800 (PST)
* Source doc: Lexicography in the Age of Open Data
----->



## **Lexicography in the Age of FAIR and Open Data**

_Level: Intermediate_

_Contributors: **CNR-ILC**, **NUIG**_
...
In the first case Open Science refers to a cross-disciplinary movement that aims to make the whole research life-cycle more open: that is, in particular, to make it (or its separate stages) more transparent, accessible and reproducible. By the research life-cycle here we refer, broadly speaking, to the following successive stages of the research process: the formulation of hypotheses, the collection and processing of data, the storage of the data (both the original data and the results of its processing), the long term storage of this data, its publication and distribution and its re-use: and since it’s a cycle we arrive back again at the formulation of (new) hypotheses.  It is important not to be misled by the use of the word ‘Science’ here, since  the term Open Science covers all areas of research and not only what are traditionally termed the natural or hard sciences. That is it also covers the Humanities and Social Sciences, including lexicography. 

The Open Science movement is partly a reaction to a crisis of reproducibility in sciences such as psychology and medicine, but it is also a response to the increasing necessity for better documentation for data and resources. More generally it is about making data and resources more easily reusable as well as getting rid of a series of other obstacles to research, including notably, the lack of accessibility to research articles (and other scientific resources) due to paywalls and the insufficient interoperability of datasets of resources.  A number of measures have been implemented by different organisations including the European Commission in order to  promote Open Sciences practises throughout the whole research life-cycle. This includes the drafting of so-called Data Management Plans that describe, among other things, how researchers plan to collect or acquire their data, and how they intend to store it, make it available and ensure its long term preservation (so that it remains accessible in the future).  



1. Before continuing with the course, take a look at the [DMP template for Horizon Europe Projects ](https://ec.europa.eu/info/funding-tenders/opportunities/docs/2021-2027/horizon/temp-form/report/data-management-plan-template_he_en.docx)and try to imagine how you would answer the requirements for your current projct

This leads us onto the topic of Open Data, which is clearly related to the topic of Open Science, since data that is subject to restrictions is by definition less accessible and re-usable. Firstly we should clarify what we mean here by Open Data, that is, when can we say that data is open? We will take our definition from the Open Data Handbook: 


    _Data is open if it can be freely accessed, used, modified and shared by anyone for any purpose - subject only, at most, to requirements to provide attribution and/or [share-alike](http://opendatahandbook.org/glossary/en/terms/share-alike-license/). Specifically, open data is defined by the [Open Definition](http://opendatahandbook.org/glossary/en/terms/open-definition/) and requires that the data be A. Legally open: that is, available under an open (data) license that permits anyone freely to access, reuse and redistribute B. Technically open: that is, that the data be available for no more than the cost of reproduction and in [machine-readable](http://opendatahandbook.org/glossary/en/terms/machine-readable/) and [bulk](http://opendatahandbook.org/glossary/en/terms/bulk/) form._
